      ...
      <div className="row">
        <div className="small-12 columns">
          <p className="about-text">
            I am <em>Brian Lusina</em>. I{' '}
            <span style={{ textDecoration: 'line-through' }}>make things</span> build systems,
            websites and applications. I love creating products that work well, feel good and
